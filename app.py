...
#         file=request.files['filename']
#         if file.filename!='':
#             file_path = os.path.join(app.config['DOCUMENT_FOLDER'], file.filename)
#             file.save(file_path)
#             input_file = file_path
#             output_file = os.path.join(app.config['DOCUMENT_FOLDER'], 'hello.docx')
#             convert_pdf2docx(input_file, output_file)
#             doc = os.path.join(app.config['DOCUMENT_FOLDER'], input_file.split(".")[0]+".docx")
#             lis = doc.replace(" ", "=")
#             return render_template("docx.html", variable=lis)
#     return render_template("index.html")
#
...
#         lis=request.form.get('filename',None)
#         lis=lis.replace("="," ")
#         file_path = os.path.join(app.config['DOCUMENT_FOLDER'], lis)
